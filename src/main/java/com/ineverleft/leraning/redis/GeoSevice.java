...
public class GeoSevice {
  ...
  //        new RedisGeoCommands.GeoLocation<>("充电宝1", new Point(Convert.toDouble(104.062325),
  // Convert.toDouble(30.56127)));
  ...
  //        redisTemplate
  //            .opsForGeo()
  //            .radius("testBattery", new Circle(new Point(104.048599, 30.549639), new Distance(50,
  // Metrics.KILOMETERS)), args);
